...
Beberapa modpack telah mendapatkan pembaruan terbit dari mereka tanpa sepengatahuan dari pencipta, menambahkan dependensi pada mod yang berbahaya. modpack tersebut memperbarui dimana terarsip secepatnya setelah mengunggah, berarti mereka *tidak menampilkan pada UI web, hanya dengan API*
...
Darkhax mengirimkan ini: https://gist.github.com/Darkhax/d7f6d1b5bfb51c3c74d3bd1609cab51f

berpontensi banyak: Sophisticated Core, Dramatic Doors, Moonlight lib, Union lib

## Stadium 0 (jar mod yang terinfeksi)
